...
<html lang="ar">
   ...
   <body class="main-layout">
      ...
      <div class="wrapper">
         ...
         <div class="sidebar">
            ...
            <nav id="sidebar">
               ...
               <ul class="list-unstyled components">
                  ...
                  <li>
                     <a href="#about">عن دمبلة</a>
                  </li>
                  <li>
                     <a href="#game">الألعاب</a>
                  </li>
                  <li>
                           ...
                           <div class="col-md-3 logo_section">
                              <div class="full">
                                 <div class="center-desk">
                                    <div class="logo">
                                       <a href="index.html"><img width="200px" src="images/logo.png" alt="#"></a>
                                    </div>
                                 </div>
                              </div>
                           </div>
         ...
         <!-- Categories -->
         <!-- casino -->
         <div id="game" class="casino"  style="direction: rtl;">
            <div class="container">
               <div class="row">
                  <div class="col-md-12">
                     <div class="titlepage">
                                    ...
                                    <div class="row d_flex">
                                       <div  class="col-md-6">
                                          <div class="test_box">
                                             ...
                                             <p>رقم واتس اب الاداره للملاحظات والشكاوي الرجاء ارسال رساله.</p>
                                             <a class="read_more" href="Javascript:void(0)">اضغط هنا </a>
                                          </div>
                                       </div>
                                       <div  class="col-md-6">
                                          <div class="test_box">
                     ...
                     <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 ">
                        <div class="address">
                           ...
                           <form class="newtetter">
                              <button class="submit">أرسال</button>
                           ...
                           <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                              <div class="address">
                                 ...
                                 <ul class="Menu_footer">
                                    ...
                                    <li><a href="#about">عن دمبلة</a> </li>
                                    <li><a href="#game">ألعاب</a> </li>
                           ...
                           <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                              <div class="address">
                                 ...
                                 <ul class="Links_footer">
                                    <li>رقم واتس اب الاداره للملاحظات والشكاوي الرجاء ارسال رساله</li>
                                 </ul>
                              </div>
                           </div>
                        </div>
